...
\usepackage{alltt}
\usepackage{minted}
% without these packages some $ characters in minted become pound symbols
...
\title[COMP1511 Programming Fundamentals]{COMP1511}
...
\definecolor{mintedColour}{rgb}{1,0.99,0.96}
\newenvironment{C}
 {\VerbatimEnvironment
  \setbeamertemplate{blocks}[rounded][shadow=true]
  \begin{mdframed}[backgroundcolor=mintedColour,roundcorner=5pt]
  \begin{minted}{c}}
 {\end{minted}
 \end{mdframed}
}
...
\newenvironment{perl}
 {\VerbatimEnvironment
  \setbeamertemplate{blocks}[rounded][shadow=true]
  \begin{mdframed}[backgroundcolor=mintedColour,roundcorner=3pt]
  \begin{minted}{perl}}
 {\end{minted}
 \end{mdframed}
}  
